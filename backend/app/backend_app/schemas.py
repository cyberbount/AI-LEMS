...
class DeviceOut(ORMModel):
    id: int; asset_code: str; name: str; category: str; status: str; serial_number: str; group_id: int | None; location_id: int | None
...
class RequestOut(ORMModel):
    id: int; user_id: int; device_id: int; purpose: str; status: str; requested_from: datetime | None; requested_to: datetime | None; created_at: datetime
